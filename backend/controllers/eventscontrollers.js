...
import {
  ...
  nettoyerValeur,
  recupererValeur,
} from "../../frontend/Projetjs/helpers.js";
import { ajouterInfosVisugpx } from "../../frontend/Projetjs/eventVisugpx.js";
import fs from "fs";
  ...
  try {
    ...
    if (
      ...
      return res.status(503).json({
        message:
          "La base de donnees est actuellement inaccessible. Verifiez la configuration MySQL et que le service est demarre.",
      });
    }
